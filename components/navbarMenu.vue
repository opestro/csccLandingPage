<template>
  ...
  <div class="navbar-start ">
    ...
    <a class="btn btn-ghost normal-case text-xl  hover:bg-[#1c4f82] tracking-widest  hover:text-[#fe0] my-2">CSCClub</a>
  </div>
  ...
  <div class="navbar-end">
    <a class="btn bg-[#1c4f82] tracking-widest  hover:bg-[#1c2682]">Get started</a>
  </div>
</div>
</template>
<script>
